...
const handleLogin = async () => {
  try {
    ...
    if (response.success) {
      ...
      console.log('response.tenant:', response.tenant)
      console.log('response.token:', response.token)
      
      // Save user info and token
      if (response.user && response.token) {
          console.log('=== 开始设置用户和token ===')
          authStore.setUser({
            id: response.user.id || '',
          ...
          console.log('=== 用户和token设置完成 ===')
          console.log('localStorage weknora_token:', localStorage.getItem('weknora_token'))
          console.log('localStorage weknora_user:', localStorage.getItem('weknora_user'))
        }
      ...
      console.log('即将跳转到: /platform/knowledge-bases')
